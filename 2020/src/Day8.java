...
public class Day8 {
    ...
    private final static List<String> miniInput = Arrays.asList("nop +0", "acc +1", "jmp +4", "acc +3", "jmp -3", "acc -99", "acc +1", "jmp -4", "acc +6");
    ...
    public static void main(String[] args) {
        ...
        int lastOperationPosition = 0;
        boolean breakNext = false;
        Set<Integer> visitedOps = new HashSet<>();

        do {
            SimpleImmutableEntry<String, Integer> currentOp = operations.get(operationPosition);

            if (visitedOps.contains(operationPosition)) {
                breakNext = true;
            } else visitedOps.add(operationPosition);
            ...
            switch (currentOp.getKey()) {
                case "acc":
                    ...
                    break;
                case "jmp":
                    operationPosition += currentOp.getValue();
                    break;
                case "nop":
                    operationPosition += 1;
                    break;
        ...
        System.out.println("Pt1: " + globalCounter);
    }
}
